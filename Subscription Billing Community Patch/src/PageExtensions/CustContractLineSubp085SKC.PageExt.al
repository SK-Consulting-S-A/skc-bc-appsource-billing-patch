...
pageextension 70631090 CustContractLineSubp085SKC extends "Customer Contract Line Subp."
{
    layout
    {
        addafter("Service Amount")
        {
            ...
            field(SubscriptionClosed085SKC; SubscriptionClosed)
            {
                ApplicationArea = All;
    ...
    var
        ...
        PreviewCalc: Codeunit SubInvoicePreviewCalc085SKC;
    begin
        NextInvoiceAmount := 0;
