...
permissionset 70631095 SubBillPatch085SKC
{
    ...
    Permissions =
        ...
        table BillingReadinessCue085SKC = X,
        tabledata BillingReadinessCue085SKC = RIMD,
        ...
        codeunit BillingReadiness085SKC = X,
        codeunit ContractMerge085SKC = X,
        codeunit ContractStatusCalc085SKC = X,
        ...
        page BillingReadinessAct085SKC = X,
