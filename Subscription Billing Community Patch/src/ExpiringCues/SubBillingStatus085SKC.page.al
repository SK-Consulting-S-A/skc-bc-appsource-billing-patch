...
page 70631071 SubBillingStatus085SKC
{
    PageType = Card;
    ...
    layout
    {
        area(Content)
        {
            group(SubscriptionInfo)
            {
                ...
                field(AutoRenewal; Rec.AutoRenewal085SKC)
                {
                    ApplicationArea = All;
            ...
            part(BillingHistoryPart; SubBillingHistory085SKC)
            {
                ApplicationArea = All;
    ...
    var
        CalcPreview: Codeunit SubInvoicePreviewCalc085SKC;
    begin
